...
curdir = '/content/gdrive/MyDrive/dp'
branch = '-b uiupdate+aria ' #'-b ariacivitnew ' <-space in the end
linetoexecute = [
    'git clone -b v2.1 https://github.com/camenduru/stable-diffusion-webui /content/gdrive/MyDrive/dp/volatile-concentration-localux', 
    f'git clone {branch}https://github.com/etherealxx/batchlinks-webui /content/gdrive/MyDrive/dp/volatile-concentration-localux/extensions/batchlinks-webui'
    ]
